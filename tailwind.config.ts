    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-ring": {
          ...
          "100%": { boxShadow: "0 0 0 28px hsl(var(--primary) / 0)" },
        },
        ...
        "corner-pulse": {
          "0%, 100%": { opacity: "0.6", filter: "drop-shadow(0 0 4px hsl(var(--primary-glow)))" },
          "50%": { opacity: "1", filter: "drop-shadow(0 0 14px hsl(var(--primary-glow)))" },
        },
      },
      animation: {
